...
static const char *fonts[]          = { "Hack Nerd Font:size=18"}; // Liberation Mono:size=18
...
static const char col_red[]         = "#851400";
...
static const char *browserinternet[] = { "librewolf", NULL };

static const Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
	{ MODKEY,                       XK_Return, spawn,          {.v = termcmd } },
	{ MODKEY,                       XK_i,      spawn,          {.v = browserinternet } },
